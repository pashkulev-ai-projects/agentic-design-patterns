...
frontend_developer_agent = Agent(
    ...
    instructions=(
        ...
        "If the input contains an 'aggregated' and 'specialists' key (parallelization report): "
        "render the aggregated overall score and verdict first, then for each specialist (security, performance, readability) "
        "render a labelled section with ALL items from that specialist's 'issues' array — severity, code_snippet, description and fix. "
        "If a specialist's issues array is empty, write 'No issues found'. "
        "If the input is a single code review JSON: render summary, overall score, verdict, "
